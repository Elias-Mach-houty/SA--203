...
- la société Vezeday’s
- située à : 4 Place Tharradin, 25200 Montbéliard
- adresse URL du site : https://eskiss.andreaslopez.fr
- adresse mail : titouan.joury@edu.univ-fcomte.fr
- téléphone : 0781681403
Le client déclare avoir pris connaissance et avoir accepté les conditions générales de vente antérieurement à la passation de la commande. La validation de la commande vaut donc acceptation des conditions générales de vente.</p>
    <h3  class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 1 - Contenu et champ d'application</h3>
    <p class="font-Corps text-black mx-auto  w-3/4 text-base">Les présentes conditions générales de vente s'appliquent de plein droit aux prestations de services suivantes : Arts.
...
L'acheteur déclare avoir pris connaissance des présentes conditions générales de vente et les avoir acceptées avant son achat immédiat ou la passation de sa commande.
    ...
    <h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 2 - Informations précontractuelles</h3>
    <p class="font-Corps text-black mx-auto  w-3/4 text-base">Préalablement à l'achat immédiat ou à la passation de la commande et à la conclusion du contrat, ces conditions générales de vente sont communiquées à l'acheteur, qui reconnaît les avoir reçues.
...
<br>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">Le prestataire de services doit également communiquer à l'acheteur, ou mettre à sa disposition, les informations suivantes :
...
<h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 3 - Commande</h3>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">Par commande, il faut entendre tout ordre portant sur les prestations figurant sur les tarifs du vendeur, et accepté par lui, accompagné du paiement de l'acompte éventuellement prévu sur le bon de commande.
...
<h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 4 - Devis</h3>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">Pour les services donnant lieu à l'établissement d'un devis préalable, la vente ne sera considérée comme définitive qu'après établissement d'un devis par le prestataire et envoi à l'acheteur de la confirmation de l'acceptation de la commande.
Les devis établis par le prestataire ont une durée de validité de 7 jours.
</p>
<h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 5 - Exécution de la prestation et résolution du contrat
</h3>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">Sauf conditions particulières expresses propres à la vente, l'exécution de la prestation s'effectuera dans le délai de 14 jours à compter de la réception par le vendeur d'une commande en bonne et due forme.
...
<h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 6- Exceptions au délai de rétractation
</h3>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">Le délai de rétractation de 14 jours ne concerne pas la ou les situations ci-dessous énumérées:
...
En cas d'annulation de la commande par l'acheteur, après acceptation du vendeur, pour quelque raison que ce soit hormis la force majeure, une somme correspondant à 20 % du montant de l'achat sera acquise au vendeur, à titre de dommages et intérêts, en réparation du préjudice ainsi subi.
</p>
<h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 7 - Prix
</h3>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">Les prix sont fermes et définitifs. Sauf conditions particulières expresses propres à la vente, les prix des prestations effectuées sont ceux figurant dans le catalogue des prix au jour de la commande.
Ils sont exprimés en monnaie légale et stipulés toutes taxes comprises.
S'ajoutent à ces prix les frais suivants : Frais de service, dans les conditions indiquées sur le catalogue tarifaire du prestataire.
</p>
<h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 8 - Paiement
</h3>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">Sauf autres modalités prévues expressément par les conditions particulières, le paiement du prix s'effectue comptant à la commande. Aucune commande ne pourra être prise en compte à défaut d'un complet paiement à cette date.
...
<h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 9 - Garanties - Généralités
</h3>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">9-1 Garantie légale de conformité
ESKISS est garant de la conformité du bien vendu au contrat, permettant à l'acheteur de formuler une demande au titre de la garantie légale de conformité prévue aux articles L. 217-3 et suivants du code de la consommation.
...
<h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 10 - Propriété intellectuelle
</h3>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">Tous les documents techniques, produits, dessins, photographies remis aux acheteurs demeurent la propriété exclusive de ESKISS, seul titulaire des droits de propriété intellectuelle sur ces documents, et doivent lui être rendus à sa demande.
...
<h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 11 - Juridiction compétente
</h3>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">Tous les litiges auxquels les opérations d'achat et de vente conclues en application des présentes conditions générales de vente pourraient donner lieu, concernant tant leur validité, leur interprétation, leur exécution, leur résiliation, leurs conséquences et leurs suites et qui n'auraient pas pu être résolus à l'amiable entre le vendeur et le client, seront soumis aux tribunaux compétents dans les conditions de droit commun.
Pour la définition de la juridiction compétente, le vendeur élit domicile à 4 Place Tharradin, 25200 Montbéliard.

</p>
<h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 12 - Langue du contrat
</h3>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">Les présentes conditions générales de vente sont rédigées en langue française. Dans le cas où elles seraient traduites en une ou plusieurs langues étrangères, seul le texte français ferait foi en cas de litige.
</p>
<h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 13 - Loi applicable
</h3>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">Les présentes conditions générales sont soumises à l'application du droit français. 
Il en est ainsi pour les règles de fond comme pour les règles de forme. En cas de litige ou de réclamation, l'acheteur s'adressera en priorité au vendeur pour obtenir une solution amiable.
</p>
<h3 class="font-Title text-black mx-auto text-center text-2xl mt-10">Article 14 - Protection des données personnelles
</h3>
<p class="font-Corps text-black mx-auto  w-3/4 text-base">Données collectées :
...
En application de la réglementation applicable aux données à caractère personnel, les utilisateurs disposent des droits ci-dessous mentionnés, qu'ils peuvent exercer en faisant leur demande à l'adresse suivante : titouan.joury@edu.univ-fcomte.fr
